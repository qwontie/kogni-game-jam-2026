...
const MENU_SHADER := preload("res://scenes/ui/main_menu/painted_stroop_menu.gdshader")
const TRANSITION_SHADER := preload("res://scenes/ui/main_menu/stroop_melt_transition.gdshader")
const PLAYER_TEXTURE := preload("res://assets/sprites/player/stroopy.png")
const ENEMY_RED := preload("res://assets/sprites/enemies/enemy_red.png")
const ENEMY_BLUE := preload("res://assets/sprites/enemies/enemy_blue.png")
const ENEMY_YELLOW := preload("res://assets/sprites/enemies/enemy_yellow.png")
const ENEMY_GREEN := preload("res://assets/sprites/enemies/enemy_green.png")
