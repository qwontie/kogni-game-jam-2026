...
const ENEMY_TEXTURES := {
	"red": preload("res://assets/sprites/enemies/enemy_red.png"),
	"green": preload("res://assets/sprites/enemies/enemy_green.png"),
	"blue": preload("res://assets/sprites/enemies/enemy_blue.png"),
	"yellow": preload("res://assets/sprites/enemies/enemy_yellow.png"),
}
const KEY_TO_COLOR := {
	"red": Color.RED,
	"green": Color.GREEN,
