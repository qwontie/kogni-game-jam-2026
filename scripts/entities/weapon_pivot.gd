...
const COLOR_TEXTURES := {
	"red": preload("res://assets/sprites/weapons/shotgun_red.png"),
	"green": preload("res://assets/sprites/weapons/shotgun_green.png"),
	"blue": preload("res://assets/sprites/weapons/shotgun_blue.png"),
	"yellow": preload("res://assets/sprites/weapons/shotgun_yellow.png"),
}
